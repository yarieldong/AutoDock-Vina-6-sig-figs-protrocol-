We used [ZINC](https://zinc15.docking.org/) to select compounds that are similar to the compounds with positive dT according to Dr. Perry's [result](./NCS_RecQ1_TSA_Hits-030922.pptx) from wet lab.
